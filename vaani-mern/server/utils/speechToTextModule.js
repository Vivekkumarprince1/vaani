...
if (!SPEECH_KEY) {
    throw new Error('Missing speech subscription key. Set AZURE_SPEECH_KEY or SPEECH_KEY.');
  }

if (!SPEECH_REGION) {
    throw new Error('Missing speech region. Set AZURE_SPEECH_REGION or SPEECH_REGION.');
  }
